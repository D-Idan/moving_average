...
from strategies.emvwap_reset_by_time import emvwap_strategy_with_reset
...
def objective(trial):
    ...
    long_window = trial.suggest_int("long_window", 32, 64*4, step=32)  # Range for long_window
    ...
    long_diff = trial.suggest_int("long_diff", 0, 16, step=8)
    confirm_days = trial.suggest_int("confirm_days", 0, 2, step=1)
